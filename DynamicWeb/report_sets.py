...
default_options = {
    ...
    'inc_gallery': True,
    'inc_families_pages': True,
    'inc_events_pages': True,
    'inc_notes_pages': True,
    'copy_media': 1,
    'print_notes_type': True,
    'inc_places_pages': True,
    'placemappages': True,
    'familymappages': True,
    'mapservice': "Google",
    'googlemapkey': "",
